...
CP="$(jar1 'org.eclipse.ui_*.jar');$(jar1 'org.eclipse.ui.workbench_*.jar');$(jar1 'org.eclipse.swt_*.jar');$SWT_FRAG;$(jar1 'org.eclipse.jface_*.jar');$(jar1 'org.eclipse.core.resources_*.jar');$(jar1 'org.eclipse.core.runtime_*.jar');$(jar1 'org.eclipse.equinox.common_*.jar');$(jar1 'org.eclipse.core.jobs_*.jar');$(jar1 'org.eclipse.osgi_*.jar');$(jar1 'org.eclipse.equinox.registry_*.jar');$(jar1 'org.eclipse.core.commands_*.jar')"
